Files named "generatingOHgaussianloop", "COgaussianloop", "HIplotsandgauss" are all gaussian loops that only need to be ran once. 
    ...
    All these files include integrals, might be wrong and definitely need to be checked for accuracy.
Files named “...159500-20000**best data” depict gaussians of the line, provide parameters, and my attempt at finding the integrals.
